define([
    ...
    function ($, api, _, Hypr, Backbone, HyprLiveContext, CustomerModels, MozuGrid, MozuGridCollection,
        ...
        var B2bChangeParentView = Backbone.MozuView.extend({
            templateName: "modules/b2b-account/account-hierarchy/parent-b2baccount",
            initialize: function () {
        ...
        return {
            'B2bChangeParentView': B2bChangeParentView
        };
    });
